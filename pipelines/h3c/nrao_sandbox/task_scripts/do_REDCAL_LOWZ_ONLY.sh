...
omnivis_ext=.ant_z_thresh.${ant_z_thresh}.omni_vis.uvh5
omnical_ext=.ant_z_thresh.${ant_z_thresh}.omni.calfits
firstcal_ext=.ant_z_thresh.${ant_z_thresh}.first.calfits
